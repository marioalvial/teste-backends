...
import teste.backends.proposal.core.events.ProponentUpdatedEvent

class ProponentUpdatedMessage(
    ...
    override fun toEvent(): ProponentUpdatedEvent = ProponentUpdatedEvent(
        id = eventId!!,
    ...
    companion object {
        fun create(messageValues: List<String>) = ProponentUpdatedMessage(
